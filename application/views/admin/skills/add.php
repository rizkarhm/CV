                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Add</strong> Skills
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="<?= base_url('admin/skills/add'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="percentage" placeholder="Percentage" class="form-control <?php echo form_error('percentage') ? 'is-invalid':'' ?>" >
                                                </div>
                                                <div class="invalid-feedback">
